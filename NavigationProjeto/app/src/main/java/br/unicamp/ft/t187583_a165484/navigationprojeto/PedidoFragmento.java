    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnFinalizarPedido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    //System.out.println("Totaaaal " + txtTotal.getText().toString());
                    //System.out.println("Totaaaal " + Double.parseDouble(txtTotal.getText().toString()));
                    Pedido pedido = new Pedido(bebidas,comidas,1, Double.parseDouble(txtTotal.getText().toString()));
